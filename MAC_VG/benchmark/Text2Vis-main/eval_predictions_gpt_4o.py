...
def main():
    ...
    parser.add_argument("--input", default=r"C:\Users\wxf\Desktop\Text2Vis-main\results_fuxian\MVG\qwen2.5_7b_20260508.xlsx")
    parser.add_argument("--output", default=r"C:\Users\wxf\Desktop\Text2Vis-main\results_fuxian\MVG\qwen2.5_7b_gpt_4o_Score.xlsx")
    parser.add_argument("--chart_dir", default="chart_Gpt4o_agentic")
    ...
    # 确保这几列存在
    for col in ["Answer Match", "Readability and Quality Score", "Chart Correctness Score", "Final Score"]:
        if col not in df.columns:
            df[col] = np.nan

    # 单条评估：逐行 evaluate_row
    N = 10  # 打印频率
